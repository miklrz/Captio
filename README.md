...
- Добавить прямую загрузку видеофайла с компьютера.
- Добавить полноценный перевод на разные языки.
- Вынести долгую обработку видео в очередь фоновых задач.
- Добавить страницу статуса обработки в реальном времени.
- Добавить PostgreSQL-режим для продакшн-развертывания.
- Добавить Alembic-миграции, если проект перейдет с SQLite на PostgreSQL.
- Добавить тесты API.
- Добавить ограничение размера файлов и чистку старых загрузок.
